...
namespace fc { namespace ecc {
    ...
    public_key private_key::get_public_key()const
    {
       ...
       FC_ASSERT( secp256k1_ec_pubkey_create( detail::_get_context(), &pubkey, (unsigned char*) my->_key.data() ));
    ...
    compact_signature private_key::sign_compact( const fc::sha256& digest, bool require_canonical )const
    {
        ...
        do
        {
            ...
            FC_ASSERT( secp256k1_ecdsa_sign_recoverable( detail::_get_context(), &sig, (unsigned char*) digest.data(), (unsigned char*) my->_key.data(), extended_nonce_function, &counter) );
            FC_ASSERT( secp256k1_ecdsa_recoverable_signature_serialize_compact(detail::_get_context(), result.begin() + 1, &recid, &sig) );
